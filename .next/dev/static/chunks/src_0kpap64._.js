...
function Home() {
    ...
    // Clue Economy State
    const [activeTab, setActiveTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('tracker');
    const [unlockedClues, setUnlockedClues] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    const [revealedClue, setRevealedClue] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [isCardFlipped, setIsCardFlipped] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const lastGpsUpdateRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0);
    ...
    const { activeTarget, minDistance, clusterTargets } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Home.useMemo": ()=>{
            ...
            if (selectedTeam !== null) {
                targets = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$locations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TARGET_LOCATIONS"].filter({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            if (selectedTeam === null) return;
            const cluesRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ref"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["database"], `teams/${selectedTeam}/unlockedClues`);
            const unsub = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onValue"])(cluesRef, {
    ...
    const buyClue = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Home.useCallback[buyClue]": async ()=>{
            if (!selectedTeam || isBuying || tokenCount < 1) return;
            setIsBuying(true);
            try {
                // All POIs in this cluster that have a clue defined
                const clusterPOIs = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$locations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TARGET_LOCATIONS"].filter({
                    "Home.useCallback[buyClue].clusterPOIs": (t)=>t.cluster === globalActiveCluster && __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$locations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["POI_CLUES"][t.id]
                }["Home.useCallback[buyClue].clusterPOIs"]);
                // Filter to those whose clue has NOT been unlocked yet
                const available = clusterPOIs.filter({
                    "Home.useCallback[buyClue].available": (t)=>!unlockedClues[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$locations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["POI_CLUES"][t.id].id]
                }["Home.useCallback[buyClue].available"]);
                ...
                if (latestCoords) {
                    ...
                    const overallNearest = clusterPOIs.reduce({
                        "Home.useCallback[buyClue].overallNearest": (nearest, poi)=>{
                    ...
                    }["Home.useCallback[buyClue].overallNearest"]);
                ...
                const clueForPOI = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$locations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["POI_CLUES"][targetPOI.id];
                // Atomic Firebase update: deduct 1 token + save clue
                const teamRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ref"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["database"], `teams/${selectedTeam}`);
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["update"])(teamRef, {
                    token_count: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["increment"])(-1),
        ...
        children: [
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            ...
                            children: [
                                "Active Phase: ",
                                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$locations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CLUSTER_NAMES"][globalActiveCluster]
                            ]
                        }, void 0, true, {
                            fileName: "[project]/src/app/page.tsx",
                            lineNumber: 481,
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    (()=>{
                                        // All POIs in this cluster that have a clue defined
                                        const clusterPOIs = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$locations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TARGET_LOCATIONS"].filter((t)=>t.cluster === globalActiveCluster && __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$locations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["POI_CLUES"][t.id]);
                                        // Count how many clues are still locked (for allUnlocked fallback)
                                        const unlockedCount = clusterPOIs.filter((t)=>unlockedClues[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$locations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["POI_CLUES"][t.id].id]).length;
                                        ...
                                        const nearestAlreadyUnlocked = nearestClueablePOI !== null && !!unlockedClues[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$locations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["POI_CLUES"][nearestClueablePOI.id].id];
                                        ...
                                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            }, void 0, true) : allUnlocked ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                children: "All Clues Unlocked for this Area ✨"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/page.tsx",
                                                lineNumber: 677,
                                                columnNumber: 23
                                            }, this) : nearestAlreadyUnlocked ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            ...
            activeTab === 'inventory' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    Object.entries(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$locations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CLUSTER_NAMES"]).map(([clusterKey, clusterName])=>{
                        const clusterNum = Number(clusterKey);
                        const clues = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$locations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CLUSTER_CLUES"][clusterNum] || [];
                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            revealedClue && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                children: [
                                    ...
                                    activeTab === 'tracker' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(Home, "/wUH2+tfWJjjVNGxB8gZiP5fRRg=");
_c = Home;
var _c;
...
//# sourceMappingURL=src_0kpap64._.js.map